...
export const ErrorMessage = ({
      ...
      >
        {/* <DelayedRender delay={5500}> */}
          <Container message={message}>
            ...
            >
              An Error Occured [From DelayedRender cmp]
  ...
  return (
    <Container message={message}>
      ...
      >
        <span>An Error Occured [From ErrorMessage] </span>
        {/* <Error text={text} /> */}
      </div>
    </Container>
  );
...
const DisplayMessage = ({ text, isCreatedByUser, message, showCursor }: any) => {
  return (
    <Container message={message}>
      <div
        className={cn(
...
export const UnfinishedMessage = ({ message }: { message: any }) => (
  <span>"The response is incomplete; it's either still processing, was cancelled, or censored. Refresh or try a different prompt."
  </span>
);
...
const MessageContent = ({
  ...
  if (error) {
    ...
    return <span>Message edit feature needs to be enabled</span>;
  } else {
    const marker = ':::plugin:::\n';
